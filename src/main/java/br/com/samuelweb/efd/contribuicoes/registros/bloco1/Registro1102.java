...
public class Registro1102 {
	...
	/**
	 * @return the vl_cred_pis_trib_mi
	 */
	...
	/**
	 * @param vl_cred_pis_trib_mi
	 *            the vl_cred_pis_trib_mi to set
	 */
	...
	/**
	 * @param vl_cred_pis_nt_mi
	 *            the vl_cred_pis_nt_mi to set
	 */
	...
	/**
	 * @param vl_cred_pis_exp
	 *            the vl_cred_pis_exp to set
	 */
