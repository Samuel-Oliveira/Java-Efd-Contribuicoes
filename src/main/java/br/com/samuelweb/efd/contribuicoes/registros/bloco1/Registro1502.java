...
public class Registro1502 {
	...
	/**
	 * @return the vl_cred_cofins_trib_mi
	 */
	...
	/**
	 * @param vl_cred_cofins_trib_mi
	 *            the vl_cred_cofins_trib_mi to set
	 */
	...
	/**
	 * @return the vl_cred_cofins_nt_mi
	 */
	...
	/**
	 * @param vl_cred_cofins_nt_mi
	 *            the vl_cred_cofins_nt_mi to set
	 */
	...
	/**
	 * @param vl_cred_cofins_exp
	 *            the vl_cred_cofins_exp to set
	 */
