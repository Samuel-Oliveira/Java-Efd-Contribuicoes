...
public class RegistroC396 {
	...
	private String alis_pis_percentual;
	...
	/**
	 * @param alis_pis_percentual
	 *            the alis_pis_percentual to set
	 */
	public void setAlis_pis_percentual(String alis_pis_percentual) {
		this.alis_pis_percentual = alis_pis_percentual;
	}
