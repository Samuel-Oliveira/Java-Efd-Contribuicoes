...
public class RegistroC800 {
	...
	/**
	 * @return the registroC820
	 */
	public List<RegistroC820> getRegistroC820() {
		if (registroC820 == null) {
			registroC820 = new ArrayList<RegistroC820>();
		}
		return registroC820;
	}

	/**
	 * @return the registroC830
	 */
	public List<RegistroC830> getRegistroC830() {
		if (registroC830 == null) {
			registroC830 = new ArrayList<RegistroC830>();
		}
		return registroC830;
	}
