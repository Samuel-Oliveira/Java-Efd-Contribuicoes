...
public class RegistroF560 {
	...
	private List<RegistroF569> registroF569;
	...
	/**
	 * @return the registroF569
	 */
	public List<RegistroF569> getRegistroF569() {
		if (registroF569 == null) {
			registroF569 = new ArrayList<RegistroF569>();
		}
		return registroF569;
	}
