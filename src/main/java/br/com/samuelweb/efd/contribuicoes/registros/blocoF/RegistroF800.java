...
public class RegistroF800 {
	...
	/**
	 * @param vl_cred_cofins
	 *            the vl_cred_cofins to set
	 */
	...
	/**
	 * @param per_cred_pis
	 *            the per_cred_pis to set
	 */
	public void setPer_cred_pis(String per_cred_pis) {
		this.per_cred_pis = per_cred_pis;
	}
}
