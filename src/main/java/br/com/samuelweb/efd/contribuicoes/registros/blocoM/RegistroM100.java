...
public class RegistroM100 {
	...
	/**
	 * @return the registroM105
	 */
	public List<RegistroM105> getRegistroM105() {
		if (registroM105 == null) {
			registroM105 = new ArrayList<RegistroM105>();
		}
		return registroM105;
	}

	/**
	 * @return the registroM110
	 */
	public List<RegistroM110> getRegistroM110() {
		if (registroM110 == null) {
			registroM110 = new ArrayList<RegistroM110>();
		}
		return registroM110;
	}
