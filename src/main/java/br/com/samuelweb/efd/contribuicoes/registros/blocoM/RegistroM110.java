...
public class RegistroM110 {
	...
	private List<RegistroM115> registroM115;
	...
	/**
	 * @return the registroM115
	 */
	public List<RegistroM115> getRegistroM115() {
		if (registroM115 == null) {
			registroM115 = new ArrayList<RegistroM115>();
		}
		return registroM115;
	}
