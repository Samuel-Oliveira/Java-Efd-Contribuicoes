...
public class RegistroM620 {
	...
	private List<RegistroM625> registroM625;
	...
	/**
	 * @return the registroM625
	 */
	public List<RegistroM625> getRegistroM625() {
		if (registroM625 == null) {
			registroM625 = new ArrayList<RegistroM625>();
		}
		return registroM625;
	}
