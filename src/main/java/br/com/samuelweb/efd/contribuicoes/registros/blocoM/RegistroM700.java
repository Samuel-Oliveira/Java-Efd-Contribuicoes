...
public class RegistroM700 {
	...
	/**
	 * @param vl_cont_apur_difer
	 *            the vl_cont_apur_difer to set
	 */
	...
	/**
	 * @param vl_cred_desc_difer
	 *            the vl_cred_desc_difer to set
	 */
