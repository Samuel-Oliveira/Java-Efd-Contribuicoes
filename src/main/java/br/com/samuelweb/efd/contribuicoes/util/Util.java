package br.com.samuelweb.efd.contribuicoes.util;
...
import br.com.samuelweb.efd.contribuicoes.exception.EfdException;

public final class Util {
	
	private final static LocalDate dataVersao1_24_0 = LocalDate.of(2017, 10, 01);
    ...
    public static boolean versao2_0_20(){
    	return LocalDate.now().isAfter(dataVersao1_24_0);
    }
