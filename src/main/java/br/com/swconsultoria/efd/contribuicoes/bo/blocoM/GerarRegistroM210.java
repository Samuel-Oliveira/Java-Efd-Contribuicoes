...
public class GerarRegistroM210 {
	...
	public static StringBuilder gerar(RegistroM210 registroM210, StringBuilder sb) {
		...
		sb.append("|").append(Util.preencheRegistro(registroM210.getVl_ajus_acres_bc_pis()));
		sb.append("|").append(Util.preencheRegistro(registroM210.getVl_ajus_reduc_bc_pis()));
		sb.append("|").append(Util.preencheRegistro(registroM210.getVl_bc_cont_ajus()));
