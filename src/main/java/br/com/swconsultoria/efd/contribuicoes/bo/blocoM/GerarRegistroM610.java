...
public class GerarRegistroM610 {
	...
	public static StringBuilder gerar(RegistroM610 registroM610, StringBuilder sb) {
        ...
        sb.append("|").append(Util.preencheRegistro(registroM610.getVl_ajus_acres_bc_cofins()));
        sb.append("|").append(Util.preencheRegistro(registroM610.getVl_ajus_reduc_bc_cofins()));
        sb.append("|").append(Util.preencheRegistro(registroM610.getVl_bc_cont_ajus()));
