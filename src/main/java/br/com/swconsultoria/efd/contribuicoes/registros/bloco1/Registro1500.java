...
public class Registro1500 {
	...
	private List<Registro1501> registro1501;

	/**
	 * @return the per_apu_cred
	 */
	...
	/**
	 * @param vl_cred_ext_apu
	 *            the vl_cred_ext_apu to set
	 */
	...
	/**
	 * @param vl_tot_cred_apu
	 *            the vl_tot_cred_apu to set
	 */
	...
	/**
	 * @return the vl_cred_desc_pa_ant
	 */
	...
	/**
	 * @param vl_cred_desc_pa_ant
	 *            the vl_cred_desc_pa_ant to set
	 */
	...
	/**
	 * @param vl_cred_per_pa_ant
	 *            the vl_cred_per_pa_ant to set
	 */
	...
	/**
	 * @return the vl_cred_dcomp_pa_ant
	 */
	...
	/**
	 * @param vl_cred_dcomp_pa_ant
	 *            the vl_cred_dcomp_pa_ant to set
	 */
	...
	/**
	 * @param sd_cred_disp_efd
	 *            the sd_cred_disp_efd to set
	 */
	...
	/**
	 * @param vl_cred_desc_efd
	 *            the vl_cred_desc_efd to set
	 */
	...
	/**
	 * @param vl_cred_per_efd
	 *            the vl_cred_per_efd to set
	 */
	...
	/**
	 * @param vl_cred_dcomp_efd
	 *            the vl_cred_dcomp_efd to set
	 */
	...
	/**
	 * @return the registro1501
	 */
	public List<Registro1501> getRegistro1501() {
		if (registro1501 == null) {
			registro1501 = new ArrayList<Registro1501>();
		}
		return registro1501;
	}
