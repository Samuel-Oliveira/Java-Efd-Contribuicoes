...
public class RegistroC600 {
	...
	/**
	 * @return the registroC605
	 */
	public List<RegistroC605> getRegistroC605() {
		if (registroC605 == null) {
			registroC605 = new ArrayList<RegistroC605>();
		}
		return registroC605;
	}

	/**
	 * @return the registroC609
	 */
	public List<RegistroC609> getRegistroC609() {
		if (registroC609 == null) {
			registroC609 = new ArrayList<RegistroC609>();
		}
		return registroC609;
	}
