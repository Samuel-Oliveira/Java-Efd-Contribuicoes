...
public class RegistroF130 {
	...
	/**
	 * @return the registroF139
	 */
	public List<RegistroF139> getRegistroF139() {
		if (registroF139 == null) {
			registroF139 = new ArrayList<RegistroF139>();
		}
		return registroF139;
	}
	...
	/**
	 * @param mes_oper_aquis
	 *            the mes_oper_aquis to set
	 */
