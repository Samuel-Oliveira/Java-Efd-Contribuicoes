...
public class RegistroF205 {
	...
	/**
	 * @return the vl_cus_inc_acum_ant
	 */
	...
	/**
	 * @return the vl_exc_bc_cus_inc_acum
	 */
	...
	/**
	 * @return the vl_cred_pis_desc_ant
	 */
	...
	/**
	 * @return the vl_cred_pis_desc_fut
	 */
	...
	/**
	 * @return the vl_cred_cofins_acum
	 */
	...
	/**
	 * @return the vl_cred_cofins_desc_ant
	 */
	...
	/**
	 * @return the vl_cred_cofins_desc_fut
	 */
	...
	/**
	 * @param vl_cus_inc_acum_ant
	 *            the vl_cus_inc_acum_ant to set
	 */
	...
	/**
	 * @param vl_cus_inc_per_esc
	 *            the vl_cus_inc_per_esc to set
	 */
	...
	/**
	 * @param vl_cus_inc_acum
	 *            the vl_cus_inc_acum to set
	 */
	...
	/**
	 * @param vl_exc_bc_cus_inc_acum
	 *            the vl_exc_bc_cus_inc_acum to set
	 */
	...
	/**
	 * @param vl_cred_pis_acum
	 *            the vl_cred_pis_acum to set
	 */
	...
	/**
	 * @param vl_cred_pis_desc_ant
	 *            the vl_cred_pis_desc_ant to set
	 */
	...
	/**
	 * @param vl_cred_pis_desc_fut
	 *            the vl_cred_pis_desc_fut to set
	 */
	...
	/**
	 * @param vl_cred_cofins_acum
	 *            the vl_cred_cofins_acum to set
	 */
	...
	/**
	 * @param vl_cred_cofins_desc_ant
	 *            the vl_cred_cofins_desc_ant to set
	 */
	...
	/**
	 * @param vl_cred_cofins_desc_fut
	 *            the vl_cred_cofins_desc_fut to set
	 */
