...
public class RegistroM200 {
	...
	/**
	 * @return the registroM205
	 */
	public List<RegistroM205> getRegistroM205() {
		if (registroM205 == null) {
			registroM205 = new ArrayList<RegistroM205>();
		}
		return registroM205;
	}

	/**
	 * @return the registroM210
	 */
	public List<RegistroM210> getRegistroM210() {
		if (registroM210 == null) {
			registroM210 = new ArrayList<RegistroM210>();
		}
		return registroM210;
	}
