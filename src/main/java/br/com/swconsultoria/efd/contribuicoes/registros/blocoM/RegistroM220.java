...
public class RegistroM220 {
	...
	private List<RegistroM225> registroM225;
	...
	/**
	 * @return the registroM225
	 */
	public List<RegistroM225> getRegistroM225() {
		if (registroM225 == null) {
			registroM225 = new ArrayList<RegistroM225>();
		}
		return registroM225;
	}
