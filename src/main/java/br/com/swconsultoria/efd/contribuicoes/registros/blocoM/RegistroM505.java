...
public class RegistroM505 {
	...
	/**
	 * @param vl_bc_cofins_tot
	 *            the vl_bc_cofins_tot to set
	 */
	...
	/**
	 * @param vl_bc_cofins_cum
	 *            the vl_bc_cofins_cum to set
	 */
	...
	/**
	 * @param vl_bc_cofins_nc
	 *            the vl_bc_cofins_nc to set
	 */
	...
	/**
	 * @return the quant_bc_cofins_tot
	 */
	...
	/**
	 * @param quant_bc_cofins_tot
	 *            the quant_bc_cofins_tot to set
	 */
