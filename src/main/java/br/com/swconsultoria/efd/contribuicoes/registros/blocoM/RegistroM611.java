...
public class RegistroM611 {
	...
	/**
	 * @return the vl_bc_cont_ant_exc_coop
	 */
	...
	/**
	 * @param vl_bc_cont_ant_exc_coop
	 *            the vl_bc_cont_ant_exc_coop to set
	 */
	...
	/**
	 * @param vl_exc_coop_ger
	 *            the vl_exc_coop_ger to set
	 */
	...
	/**
	 * @param vl_exc_esp_coop
	 *            the vl_exc_esp_coop to set
	 */
